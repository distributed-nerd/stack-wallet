...
const data = JSON.parse(fs.readFileSync('./sim-counter-100-results.json', 'utf8'));
...
(async () => {
  ...
  fs.writeFileSync('./sim-counter-100-confirmed.json', JSON.stringify({
    polledAt: new Date().toISOString(),
    success, abort, pending, other,
    states: Object.fromEntries(states),
  }, null, 2));
  console.log('\nSaved to sim-counter-100-confirmed.json');
})();
