...
const TOTAL_TXS = 100;
const MIN_BALANCE_USTX = 20000; // ~4 txs worth of fees (20000) buffer
...
async function main() {
  ...
  fs.writeFileSync('./sim-counter-100-fee005-results.json', JSON.stringify({
  ...
  console.log('Results saved to sim-counter-100-fee005-results.json');
}
