...
const TOTAL_TXS = 400;
const MIN_STX_USTX = 9000;          // ~8 txs worth of fee (8000) + buffer
const MIN_TOKEN = TRANSFER_AMOUNT * 9n; // enough for 8 transfers + buffer
...
async function main() {
  ...
  fs.writeFileSync('./sim-sip010-400-fee001-results.json', JSON.stringify({
  ...
  console.log('Results saved to sim-sip010-400-fee001-results.json');
}
