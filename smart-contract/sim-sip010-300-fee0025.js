...
const TOTAL_TXS = 300;
const MIN_STX_USTX = 18000;         // ~6 txs worth of fee (15000) + buffer
...
async function main() {
  ...
  fs.writeFileSync('./sim-sip010-300-fee0025-results.json', JSON.stringify({
  ...
  console.log('Results saved to sim-sip010-300-fee0025-results.json');
}
